...
(function () {
  ...
  const STRINGS = {
    en: {
      ...
      menubar_text: "Flip on the optional menu bar and a thin, always-acrylic strip docks to the top of your primary screen — Windows logo menu, the focused app's real name, a keyboard-layout switcher, Quick Settings, Notifications, and a clock.",
    ...
    "pt-BR": {
      ...
      menubar_text: "Ative a barra de menus opcional e uma faixa fina, sempre acrílica, encaixa no topo da tela principal — menu com o logotipo do Windows, o nome real do app em foco, um seletor de layout de teclado, Configurações Rápidas, Notificações e um relógio.",
    ...
    es: {
      ...
      menubar_text: "Activa la barra de menús opcional y una franja fina, siempre acrílica, se acopla en la parte superior de tu pantalla principal: menú con el logotipo de Windows, el nombre real de la app en foco, un selector de distribución de teclado, Configuración rápida, Notificaciones y un reloj.",
    ...
    uk: {
      ...
      menubar_text: "Увімкніть необов'язковий рядок меню — і тонка, завжди акрилова смуга закріплюється вгорі основного екрана: меню з логотипом Windows, справжня назва активної програми, перемикач розкладки клавіатури, Швидкі параметри, Сповіщення та годинник.",
    ...
    "zh-Hans": {
      ...
      menubar_text: "开启可选的菜单栏，一条纤薄、始终亚克力的横栏便会停靠在主屏幕顶部——Windows 徽标菜单、当前应用的真实名称、键盘布局切换器、快速设置、通知，以及时钟。",
